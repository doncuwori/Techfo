...
const LoginForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('/api/login', { // Change this to your API endpoint
                method: 'POST',
                headers: {
        ...
        <div className="w-1/2 h-full flex justify-center items-center relative z-10">
            ...
            <div className="relative w-[598px] bg-white rounded-3xl border border-[#d1d3d8] p-12 shadow-lg flex flex-col items-center gap-6 z-20">
                ...
                <form className="w-full space-y-6" onSubmit={handleSubmit}>
                    ...
                    <button
                        type="submit"
                        className={`w-full px-6 py-3 ${loading ? 'bg-gray-400' : 'bg-[#fe632e]'} text-white text-base font-medium rounded-lg hover:bg-[#e5571e] transition-colors`}
