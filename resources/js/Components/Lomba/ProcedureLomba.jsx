            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="/prosedure" className="CardInformasi">
                    <div className="px-6 py-8 bg-white rounded-2xl shadow border flex flex-col items-start gap-3 hover:bg-orange-100 transition-colors duration-300">
                        ...
                        <div className="Content flex flex-col gap-1">
                            <div className="ProsedurLomba text-gray-900 text-lg font-medium leading-7">Prosedur Pendaftaran Lomba</div>
                            <div className="PelajariProsedurLomba text-gray-600 text-sm font-normal leading-tight">
                                Pelajari prosedur lomba agar setiap langkah dalam pencapaianmu selalu tercatat!
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <div className="CardInformasi">
                    <div className="px-6 py-8 bg-white rounded-2xl shadow border border-Neutral-neutral-100 flex flex-col items-start gap-3 hover:bg-orange-100 transition-colors duration-300">
                        ...
                        <div className="Content flex flex-col gap-1">
                            <div className="ProsedurBeasiswa text-gray-900 text-lg font-medium leading-7">Prosedur Pendataan Prestasi Lomba</div>
                            <div className="PelajariProsedurBeasiswa text-gray-600 text-sm font-normal leading-tight">
                                Pelajari prosedur beasiswa agar setiap langkah menuju prestasimu selalu tercatat!
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="CardInformasi">
                    <div className="px-6 py-8 bg-white rounded-2xl shadow border border-Neutral-neutral-100 flex flex-col items-start gap-3 hover:bg-orange-100 transition-colors duration-300">
                        ...
                        <div className="Content flex flex-col gap-1">
                            <div className="ProsedurPengabdianMasyarakat text-gray-900 text-lg font-medium leading-7">Prosedur Pengajuan Reward Fakultas</div>
                            <div className="PelajariProsedurPengabdianMasyarakat text-gray-600 text-sm font-normal leading-tight">
                                Pelajari prosedur pengabdian masyarakat agar proses pendaftaranmu lebih lancar!
                            </div>
                        </div>
                    </div>
                </div>
