    ...
    return (
        <div className="w-full flex flex-col gap-6 mb-12 relative z-10">
            <div className="w-full px-16 flex justify-between items-center">
                <h1 className="text-black text-2xl font-semibold">Informasi Penelitian</h1>
                ...
                {researchProjects.map((project, index) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                            <h2 className="text-black text-lg font-medium">{project.title}</h2>
                            <p className="text-gray-500 text-sm">{project.description}</p>
                            <div className="flex items-center gap-2">
                                <img src="img/waktu.png" alt="Jam" className="w-4 h-4 object-contain" />
                                <span className="text-orange-500 text-xs font-medium leading-tight">{project.date}</span>
                            </div>
                        </div>
                    </div>
                ))}
