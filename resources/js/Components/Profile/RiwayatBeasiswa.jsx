...
const RiwayatBeasiswa = ({ data }) => {
    return (
        <div className="py-6 px-8 mb-6">
            <h2 className="text-2xl font-semibold mb-6">
                Riwayat Partisipasi Beasiswa
            </h2>
                ...
                {data.map((d, index) => (
                    ...
                    >
                        <div className="w-[125px] h-[127px] relative">
                            <img
                                src={d.scholarship_registrant.poster_url != null ? "/images/" + d.scholarship_registrant.poster_url : "/images/noimage.png"}
                        ...
                        {
                            d.scholarship_registrant.exist ? 
                            <div className="absolute bottom-4 right-4 bg-green-500 p-1 px-4 rounded-md text-white hover:shadow-lg">
                                Sudah Mengisi
                            </div>
                            :
                            <a href={route('scholarship-recipient.fill-create', d.scholarship_registrant.id)} className="absolute bottom-4 right-4 bg-blue-500 p-2 px-4 rounded-md text-white hover:shadow-lg">Isi Form Prestasi</a>
                        }
...
export default RiwayatBeasiswa;
