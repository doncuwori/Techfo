...
import { FormMasterScholarship } from "@/Components/MasterScholarship/FormMasterScholarship";

const EditMasterScholarship = ({ user, data }) => {
            ...
            <div className="flex w-full ml-[256px] mt-8">
                <main className=" flex grow   items-center justify-center py-14 px-4 ">
                    <div className="bg-white shadow-md rounded-lg p-8 max-w-[1200px] w-[70%] mx-auto">
                        ...
                        <FormMasterScholarship edit={true} previous={data}/>
                    </div>
                </main>
            </div>
        </div>
...
export default EditMasterScholarship;
