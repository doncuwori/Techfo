        ...
        <div class="flex-1 p-6">
            <div class="bg-white shadow-md rounded-lg p-6">
                ...
                <div class="mt-4">
                    ...
                    <p>Pada kegiatan penelitian ini, mahasiswa akan turut serta membantu para dosen dalam melakukan risetnya di Desa Pabean Udik, Indramayu dalam menggunakan aplikasi E-Commerce...</p>
                </div>
            ...
            <div class="mt-6 bg-white shadow-md rounded-lg p-6">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-semibold">Pendaftar Penelitian</h3>
