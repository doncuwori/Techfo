...
const TambahPenerima = ({ jenisBeasiswa, country, mahasiswa, user }) => {
    ...
    const handleSubmit = (e) => {
        ...
        post(route("laporanBeasiswa.store-recipient"), {
            onSuccess: (res) => {
                reset();
        ...
        <div>
            ...
            <div class="pl-72 w-full">
                ...
                <form onSubmit={handleSubmit}
                    className="p-8 shadow rounded-md border mx-4">
                    ...
                    <section className="mb-8">
                        ...
                        <div className="mb-4">
                            ...
                            <ul className="text-gray-500 list-disc list-inside">
                                <li>
                                    Detail scan berupa bukti atau dokumen
                                    penerima beasiswa yang telah disahkan dengan
                                    stempel basah;
                                </li>
                                <li>
                        ...
                        <div className="mb-4">
                            ...
                            <ul className="text-gray-500 list-disc list-inside">
                                <li>
                                    Poster kegiatan yang diikuti, menunjukkan
                                    nama lomba;
                                </li>
                                <li>
                                    Berkas yang diunggah dalam format: .jpg,
