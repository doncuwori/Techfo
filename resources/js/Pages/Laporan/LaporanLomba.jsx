  ...
  return (
    ...
    <div class="pl-64 w-full">
        <div class="container px-4 py-8 w-full">
            <h1 class="text-3xl font-bold text-black mb-6">Pusat Informasi</h1>
            <div class="flex flex-wrap -mx-4 mb-6">
                <div class="w-full md:w-1/3 px-4">
                    <div class="bg-white rounded-lg border-2 border-neutral-100 p-4 flex items-center">
                        <div class="w-[87px] h-[87px] relative">
                            <div
                                class="absolute">
                                <CircularProgressbar className="h-24 w-24" value={value} maxValue={1} text={`${value * 100}%`} /></div>
                ...
                <div class="w-full md:w-1/3 px-4">
                    <div class="bg-orange-100 rounded-lg border-2 border-neutral-100 p-4 flex items-center">
                        <div class="text-5xl ml-2 mr-6">
                            🏆
                        </div>
                        <div>
                            <h2 class="text-xl font-semibold text-black mb-4">Pemenang Lomba</h2>
                ...
                <div class="w-full md:w-1/3 px-4">
                    <div class="bg-orange-100 rounded-lg border-2 border-neutral-100 p-4 flex items-center">
                        ...
                        <div>
                            <h2 class="text-xl font-semibold text-black mb-4">Partisipan Lomba</h2>
                            <div class="text-4xl font-bold text-black">135</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white p-4 rounded-lg shadow-lg mt-6 mb-6 border-2 border-neutral-100">
                <div class="flex items-center space-x-2 mb-4">
                    <button class="bg-green-500 text-white px-4 py-2 rounded-md font-semibold">Penerima</button>
                    <button
                        class="bg-white text-green-500 px-4 py-2 border border-green-500 rounded-md font-semibold">Pendaftar</button>
                </div>
                <div class="flex justify-between items-center relative w-full">
                    ...
                    <div class="flex space-x-2">
                        <button
                            class="bg-white text-green-500 px-4 py-2 border border-green-500 rounded-md font-semibold">Filter</button>
                ...
                <table class="min-w-full divide-y divide-gray-200 ">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">1234567890</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">John Doe</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">KSM Android</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Erly Krisnanik S.Kom., MM.</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">UI/UX Designer</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">PT. Cipta Karya</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Indonesia</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">PT. Cipta Karya</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">14 Desember 2024</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">lorem ipsum</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Bukti.png</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Kegiatan.png</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">lorem ipsum</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Bukti.png</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Kegiatan.png</td>                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center">11</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">1234567890</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">John Doe</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">KSM Android</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Erly Krisnanik S.Kom., MM.</td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center">13</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">1234567890</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">John Doe</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">KSM Android</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Erly Krisnanik S.Kom., MM.</td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center">14</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">1234567890</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">John Doe</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">KSM Android</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Erly Krisnanik S.Kom., MM.</td>
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-center">15</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">1234567890</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">John Doe</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">KSM Android</td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">Erly Krisnanik S.Kom., MM.</td>
